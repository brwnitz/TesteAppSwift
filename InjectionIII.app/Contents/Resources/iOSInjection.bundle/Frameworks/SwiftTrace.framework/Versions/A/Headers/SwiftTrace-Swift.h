...
@property (nonatomic, strong) SwiftTrace * _Nullable previousSwiftTrace;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) double slowThreshold;)
+ (double)slowThreshold SWIFT_WARN_UNUSED_RESULT;
+ (void)setSlowThreshold:(double)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull slowEmphasis;)
+ (NSString * _Nonnull)slowEmphasis SWIFT_WARN_UNUSED_RESULT;
+ (void)setSlowEmphasis:(NSString * _Nonnull)value;
